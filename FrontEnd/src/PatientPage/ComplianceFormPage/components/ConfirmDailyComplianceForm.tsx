            ...
            <div className="flex h-full w-full flex-col gap-3 px-4">
                ...
                <div className={`grid w-full grid-cols-1 flex-col gap-3 tablet:grid-cols-2 tablet:gap-x-20`}>
                    ...
                    <YesOrNoViewButton
                        ...
                        value={
                            isPod1
                                ? values.podOneGiStimulant
                                : isPod2
                                  ? values.podTwoGiStimulant
                                  : values.podThreeGiStimulant
                        }
                        remark={
                            isPod1
                                ? values.podOneGiStimulant_remarks
                                : isPod2
                                  ? values.podTwoGiStimulant_remarks
                                  : values.podThreeGiStimulant_remarks
                        }
