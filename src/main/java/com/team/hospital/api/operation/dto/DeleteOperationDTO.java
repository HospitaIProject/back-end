...
public class DeleteOperationDTO {
    ...
    public static DeleteOperationDTO toEntity(Operation operation, boolean complicationRegistered, double complicationScore, double compliancePercentage){
        return DeleteOperationDTO.builder()
                .operationDTO(OperationDTO.toEntity(operation, complicationRegistered, complicationScore, compliancePercentage))
